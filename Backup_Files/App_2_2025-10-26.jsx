...
// GeomanDraw: creation-only bridge from Geoman -> React state
...
function PolylineWithGeoman({ feature, style, onEdit, onDelete, onClick, children }) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      layer.pm.setOptions({ draggable: false, snappable: true });
    } catch {}
  ...
  return (
    ...
    >
      {/* Popup shows on hover. Non-interactive so it doesn’t fight with click. */}
