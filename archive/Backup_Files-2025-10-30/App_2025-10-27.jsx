  ...
  children.push(
    ...
    new Table({
      ...
      rows: [
        new TableRow({
          tableHeader: true,
          children: [new TableCell({ children: [new Paragraph(t.metric)] }), new TableCell({ children: [new Paragraph(t.value)] })],
        }),
        ...[
...
function Controls({
  ...
  // rest omitted for brevity in archive copy (file preserved in archive)
```
